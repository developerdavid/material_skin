...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="pageHeader masterhead">
                        <?php
    ...
    <div class="col-md-3">
            ...
            skin_container(NT_('Sidebar'), array(
                ...
                . '<a onClick="return false;" class="panel-toggle" data-toggle="collapse" data-target".pcollapse-0" href="#"></a>'
                . '<span class="panel-icon"><i class="fa fa-ellipsis-v"></span>'
                . '</i><span class="panel-title">',
